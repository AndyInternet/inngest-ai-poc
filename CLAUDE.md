...
├── flow.ts           # Pipeline orchestration + hooks + transitions
...
```typescript
import { createAgentPipeline, defineAgent, validatePipeline } from "./ai/flow";
import type { PipelineContext, PipelineHooks, ErrorRecoveryResult } from "./ai/flow";
...
```typescript
import { runAgentsInParallel } from "./ai/flow";
